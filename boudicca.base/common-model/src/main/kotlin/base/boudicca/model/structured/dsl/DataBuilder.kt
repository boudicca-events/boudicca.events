...
class DataBuilder<T>(private val name: String, private var defaultFormatAdapter: AbstractFormatAdapter<T>? = null) {
    ...
    fun data(data: T) {
        ...
        // TODO: this is somehow a hack, but works good enough for now
