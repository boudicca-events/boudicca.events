        ...
        fun fromEntry(entry: StructuredEntry): StructuredEvent {
            ...
            val namePair =
                KeySelector
                    ...
                    .build()
                    .selectSingle(entry)
            require(namePair != null && startDatePair != null) { "in order to convert to event name and date must be defined!" }
            val name = namePair.second
            val startDate = DateFormatAdapter().fromString(startDatePair.second)
