...
class DateParserTest {
    companion object {
        ...
        fun testDate(
            dateText: String,
            expected: String,
        ): Triple<List<String>, List<DatePair>, DateParserConfig> = testDate(listOf(dateText), listOf(DatePair(OffsetDateTime.parse(expected))))

        fun testDate(
            dateText: String,
            expected: DatePair,
        ): Triple<List<String>, List<DatePair>, DateParserConfig> = testDate(listOf(dateText), listOf(expected))

        fun testDate(
            dateText: List<String>,
            expected: DatePair,
        ): Triple<List<String>, List<DatePair>, DateParserConfig> = testDate(dateText, listOf(expected))

        fun testDate(
            dateText: List<String>,
            expected: String,
        ): Triple<List<String>, List<DatePair>, DateParserConfig> = testDate(dateText, pair(expected, null))
        ...
        private fun pair(
            startDate: String,
            endDate: String?,
        ): DatePair = DatePair(OffsetDateTime.parse(startDate), endDate?.run { OffsetDateTime.parse(this) })
