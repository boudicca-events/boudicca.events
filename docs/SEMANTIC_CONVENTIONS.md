...
|------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|-----------------------------|
| boudicca.id                                    | Generated Id of the event on this server. Generated from the three mandatory properties, `name`, `startDate`, `collectorName`. Is always regenerated on ingest and can not be set by EventCollectors. | text                     | GENERATED                   |
| boudicca.duplicateIds                          | List of Ids marking this event as duplicates of those events.                                                                                                                                         | list                     | GENERATED                   |
