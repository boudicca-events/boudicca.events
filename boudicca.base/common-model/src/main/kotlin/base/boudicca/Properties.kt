...
abstract class AbstractProperty<T>(private val propertyName: String, val adapter: AbstractFormatAdapter<String>) :
    Property<T> {
...
open class GenericProperty<T>(private val propertyName: String, protected val adapter: AbstractFormatAdapter<T>) :
    Property<T> {
