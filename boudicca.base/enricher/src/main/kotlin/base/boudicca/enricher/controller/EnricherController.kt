...
@RestController
@RequestMapping("/")
class EnricherController(private val enricherService: EnricherService) : EnricherApi {
    @PostMapping(
        "enrich",
    ...
    @ResponseBody
    override fun enrich(@RequestBody enrichRequestDTO: EnrichRequestDTO): List<Event> = enricherService.enrich(enrichRequestDTO)
