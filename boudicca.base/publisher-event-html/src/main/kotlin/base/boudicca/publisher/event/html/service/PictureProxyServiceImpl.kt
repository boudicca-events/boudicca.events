...
// TODO what happens with relative urls?
@Service
class PictureProxyServiceImpl(
    otel: OpenTelemetry,
) : PictureProxyService {
    ...
    override fun submitPicture(url: String): UUID {
    ...
    override fun getPicture(uuid: UUID): Optional<ByteArray> = idToImageCache[uuid]?.get()?.optionalPicture ?: Optional.empty()
