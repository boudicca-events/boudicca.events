...
internal object Patterns {
    ...
    fun applyStricterPatternsAndMergeResult(inputTokens: List<Token>, dayMonthOrder: DateParserConfig.DayMonthOrder): List<Token> {
    ...
    private fun getStricterPatternsForCount(countOfInterestingTokens: Int, dayMonthOrder: DateParserConfig.DayMonthOrder): List<Pattern> {
    ...
    private fun findAllValidReplacements(inputTokens: List<Token>, matchesPerPattern: List<List<Pair<Set<Int>, List<Token>>>>): List<List<Token>> {
    ...
    private fun mergeResultTypes(inputTokens: List<Token>, componentLists: List<List<Token>>, exhaustive: Boolean): List<Token> {
    ...
    private fun applyGuessesAndIntersect(inputGuesses: List<Token>, guesses: List<Pattern>): List<Token> {
    ...
    private fun findAllReplacements(inputGuesses: List<Token>, pattern: Pattern, whiteout: Boolean): List<Pair<Set<Int>, List<Token>>> {
    ...
    private fun tryMatchAndReplacePatternAtPosition(inputGuesses: List<Token>, pattern: Pattern, whiteout: Boolean, i: Int): Pair<Set<Int>, List<Token>>? {
