...
fun StructuredEntry.toFlatEntry(): Entry = KeyUtils.toFlatKeyValuePairs(this)

fun StructuredEntry.toEvent(): Optional<StructuredEvent> = StructuredEvent.fromEntry(this)

fun StructuredEntry.toBuilder(): StructuredEntryBuilder = StructuredEntryBuilder(this)
 ...
 */
fun <T> StructuredEntry.getProperty(property: Property<T>): List<Pair<Key, T>> = getProperty(property, null)
 ...
 */
fun <T> StructuredEntry.getProperty(property: Property<T>, language: String?): List<Pair<Key, T>> = KeyFilters.filterKeys(property.getKeyFilter(language), this).mapNotNull {
    try {
...
fun StructuredEntry.filterKeys(keyFilter: KeyFilter): List<Pair<Key, String>> = KeyFilters.filterKeys(keyFilter, this)

fun StructuredEntry.selectKey(keySelector: KeySelector): Optional<Pair<Key, String>> = keySelector.selectSingle(this)
