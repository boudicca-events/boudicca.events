package events.boudicca.enricher.service.osm
...
class OsmEnricherTest {
        ...
        OsmEnricher(
            ...
            Fetcher(
                ...
                object : HttpClientWrapper {
                    ...
                    override fun doPost(url: String, contentType: String, content: String): Pair<Int, String> = throw NotImplementedError("this enricher does not use post")
                },
            ),
        )
    ...
    @Test
    fun testNoop() {
        val event = StructuredEvent("Test Event", OffsetDateTime.now())
    ...
    fun `test structured event with osm_id provided`() {
        val event =
            structuredEvent("Test Event", OffsetDateTime.now()) {
