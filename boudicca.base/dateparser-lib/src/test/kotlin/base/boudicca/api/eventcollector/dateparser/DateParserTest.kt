...
class DateParserTest {
    companion object {
        val testDates: List<Triple<List<String>, List<DatePair>, DateParserConfig>> =
            listOf(
                // simple dates
                ...
                testDate(
                    listOf("13.07.2025 und 14.07.2025"),
                    listOf(
                        pair("2025-07-13T00:00+02:00", null),
                        pair("2025-07-14T00:00+02:00", null),
                    ),
                ...
                testDate(
                    listOf("25. und 26. + 27.07.2025 10:30"),
                    listOf(
                ...
                testDate(
                    listOf("16:00 - 18:00 und 19:00 - 21:00 am 25.7.2025"),
                    listOf(
                ...
                testDate(
                    listOf("16:00 - 18:00 23.7.2025 und 19:00 - 21:00 am 25.7.2025"),
                    listOf(
                ...
                testDate(
                    listOf("16 Uhr und 18 Uhr 25.7.25"),
                    listOf(
                ...
                testDate(
                    listOf("25. und 26. + 27.07.2025 10:30 - 11:00"),
                    listOf(
        ...
        fun testDate(dateText: String, expected: String): Triple<List<String>, List<DatePair>, DateParserConfig> =
            testDate(listOf(dateText), listOf(DatePair(OffsetDateTime.parse(expected))))

        fun testDate(dateText: String, expected: DatePair): Triple<List<String>, List<DatePair>, DateParserConfig> = testDate(listOf(dateText), listOf(expected))

        fun testDate(dateText: List<String>, expected: DatePair): Triple<List<String>, List<DatePair>, DateParserConfig> = testDate(dateText, listOf(expected))

        fun testDate(dateText: List<String>, expected: String): Triple<List<String>, List<DatePair>, DateParserConfig> = testDate(dateText, pair(expected, null))

        fun testDate(dateText: List<String>, expected: List<DatePair>, config: DateParserConfig? = null): Triple<List<String>, List<DatePair>, DateParserConfig> = Triple(
            dateText,
            expected,
        ...
        private fun pair(startDate: String, endDate: String?): DatePair = DatePair(OffsetDateTime.parse(startDate), endDate?.run { OffsetDateTime.parse(this) })

        private fun testDateWithFixedClock(dateText: String, expected: DatePair, fixedClockDate: String): Triple<List<String>, List<DatePair>, DateParserConfig> {
        ...
        ): Triple<List<String>, List<DatePair>, DateParserConfig> = testDate(
            listOf(dateText),
            listOf(expected),
            DateParserConfig(
